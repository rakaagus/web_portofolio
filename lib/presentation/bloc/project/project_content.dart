...
class ProjectContent extends StatefulWidget {
  ...
  const ProjectContent({super.key, required this.scrollController});

  @override
  State<ProjectContent> createState() => _ProjectContentState();
}

class _ProjectContentState extends State<ProjectContent> with SingleTickerProviderStateMixin {
